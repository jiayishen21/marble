...
export default function Meet() {
  ...
  return (
    <>
      <main className="w-full px-[1.5rem] md:px-[2.5rem] lg:px-[3.5rem] xl:px-[4.5rem] 2xl:px-[6.5rem] flex flex-col gap-12 mb-[8rem]">
        <div>
          <section className="gap-[2rem]">
            ...
            2xl:text-5xl mt-[5rem]"
              ...
              <span className="text-semiblack text-base md:text-lg xl:text-xl max-w-[55%]">
